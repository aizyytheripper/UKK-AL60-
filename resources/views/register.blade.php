...
<head>
    ...
    <title>Registrasi Siswa - Aspirasi SMKN 4 Tangerang | EDURAV</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="col-md-8 col-lg-5">
                    <div class="card p-4 p-sm-5">
                        <div class="text-center">
                            ...
                            <h3 class="auth-title">Daftar Akun Siswa</h3>
                            <p class="auth-subtitle">Registrasi untuk mulai menyampaikan aspirasi sekolah.</p>
                        </div>
                        ...
                        <form action="{{ route('register.siswa') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control border-start-0 ps-0" placeholder="siswa@example.com" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nisn" class="form-control border-start-0 ps-0" placeholder="Masukkan 10 digit NISN" required>
                                </div>
                            </div>
                            ...
                            <div class="text-center mt-3">
                                <a href="{{ url('/login/siswa') }}" class="text-decoration-none text-muted" style="font-size: 0.9rem;">
                                    Sudah punya akun? <strong class="text-primary">Login di sini</strong>
                                </a>
                                <br>
                                <a href="{{ url('/') }}" class="text-decoration-none text-muted d-lg-none mt-2 d-inline-block" style="font-size: 0.9rem;">
