...
<head>
    ...
    <title>Login Admin - Aspirasi SMKN 4 Tangerang | EDURAV</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="col-md-8 col-lg-5">
                    <div class="card p-4 p-sm-5">
                        <div class="text-center">
                            ...
                            <p class="auth-subtitle">Masuk ke dashboard panel pengelola aspirasi sekolah.</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login.admin') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control border-start-0 ps-0" placeholder="Gunakan Email Admin"  required>
                                </div>
                            </div>
